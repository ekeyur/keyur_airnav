...
// Updated code for adding Nodes (Wrote the above method again by keyur to accomodate for airnav)
...
addNode(name, neighbors) {
  ...
  if (!(this.graph.has(name))) {
    ...
    var current = this.graph.get(name);
    var newObj = neighbors;
